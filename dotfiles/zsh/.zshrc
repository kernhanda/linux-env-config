# UTF-8 locale must be set before the tmux auto-launch below — tmux locks
# client_utf8 from LANG/LC_CTYPE at attach time, and the login env here has none.
